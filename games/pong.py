...
def draw(c):
    ...
    c.draw_line([WIDTH - 1 - PAD_WIDTH / 2, paddle2_pos], [WIDTH - 1 - PAD_WIDTH / 2, paddle2_pos + PAD_HEIGHT], PAD_WIDTH, "Red")
    ...
    c.draw_circle(ball_pos, BALL_RADIUS, 2, "White", "Red")
    c.draw_text(str(score1), [WIDTH / 4, HEIGHT / 4], 45, "Yellow")
    c.draw_text(str(score2), [WIDTH * 3 / 4 - 30, HEIGHT / 4], 45, "Yellow")
